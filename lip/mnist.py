...
eps_min = .001
eps_max = 7
#eps_min_net = .001 # for small epsilon plot
#eps_max_net = .3 # for small epsilon plot
#eps_min_net = .2 # for classification bounds
#eps_max_net = .3 # for classification bounds
#eps_min_layer = .001
#eps_max_layer = 200
#eps_min_bisect = .25 # real
#eps_max_bisect = .27 # real
