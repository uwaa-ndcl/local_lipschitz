...
eps_min = .001
eps_max = 3
#eps_min_bisect = 3e-5 # real
#eps_max_bisect = 4e-5 # real
eps_min_bisect = 0.9e-5 # test
eps_max_bisect = 1.1e-5 # test
step_size_grad = 1e-3
main_dir = dirs.alexnet_dir
...
# nominal input
filename = os.path.join(dirs.imagenet_dir, 'toucan.png')
...
# get class names
classes_file = os.path.join(dirs.imagenet_dir, 'classes.txt')
